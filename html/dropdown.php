...
<form method="POST">
<select name="movie" id="movie-dropdown">
  <?php
  # ALL THIS NEEDS TO BE TESTED!!!
  $pollid = $_GET["pollid"];  # This depends on poll id being part of the query string
  $movies = json_decode("{\"movies:\" \"" . file_get_contents("./polls/" . $pollid . "/movies.json") . "\"", true);
